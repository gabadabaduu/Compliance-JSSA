...
export default function DataHeader({ onCreateClick }: DataHeaderProps) {
    return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                        <Icon icon="mdi:database" width="32" height="32" className="text-purple-500" />
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-200">
                            Almacenamiento de Datos ROPA
                        </h1>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                            Gestión de bases de datos y almacenamiento de datos personales
                        </p>
                    </div>
                </div>
