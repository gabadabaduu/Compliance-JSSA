...
interface HabeasDataHeaderProps {
    onCreateClick: () => void;
}

export default function HabeasDataHeader({ onCreateClick }: HabeasDataHeaderProps) {
    return (
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center">
                        <Icon icon="mdi:shield-account" width="32" height="32" className="text-purple-500" />
                    </div>
                    <div>
