    ...
    if (catalogType === 'entity') {
        return (
            <div className="overflow-x-auto">
                {/* Header de tabla */}
                <div className="grid grid-cols-[1fr_100px_1fr_80px] gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 text-xs font-medium text-gray-600 dark:text-gray-400 uppercase">
                    <span>Nombre</span>
                    <span>Industria</span>
                ...
                <div className="max-h-48 overflow-y-auto">
                    {(items as Entity[]).map((item) => (
                        <div 
                            key={item.id} 
                            className="grid grid-cols-[1fr_100px_1fr_80px] gap-2 px-4 py-2.5 border-b border-gray-100 dark:border-gray-800 last:border-b-0 hover:bg-gray-50 dark:hover:bg-gray-800/30 transition-colors items-center"
                        >
