...
export function useCatalog(endpoint: string) {
    ...
    const queryKey = ['catalog-sanctions', endpoint];  // 🆕 Cambio:  sanctions en lugar de resolutions
    ...
    const createMutation = useMutation({
        mutationFn: (data: CreateCatalogDto) => catalogService.create(endpoint, data),
        onSuccess: () => {
